...
The agent logs in to iam-service as a fixed service-account user
(SERVICE_ACCOUNT_EMAIL/SERVICE_ACCOUNT_PASSWORD) and caches the resulting
JWT until shortly before its 1-hour expiry.
"""
import os
import threading
import time
...
# IAM tokens live 3600s; refresh 5 minutes early to avoid edge-of-expiry races.
